...
#include "ns3/ndnSIM/utils/ndn-fw-judge-tag.h"
#include "ns3/ndnSIM/utils/ndn-fw-cs-tag.h"
...
ConsumerZipfMandelbrot::SendPacket() {
  ...
  FwCsTag fwCsTag;
  interest->GetPayload ()->AddPacketTag (fwCsTag);

  FwJudgeTag fwJudgeTag;
  interest->GetPayload ()->AddPacketTag (fwJudgeTag);
...
//std::cout<<"conten_index = "<<content_index<<"  gailv = "<<p_sum<<"\n";
